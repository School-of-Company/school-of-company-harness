...
- **Conventions are ours.** Strip the source's commit/PR format, labels, and any AI co-author line.
  Our commit and PR rules live in `.claude/shared/commit-conventions.md`.
...
`.claude/shared/commit-conventions.md`. Verify the result the way the rest of the catalog is verified:

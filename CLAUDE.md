...
- `.claude/shared/` — documents several items share (e.g. commit conventions); pulled into a PR by
  whichever selected item references them, so the rules live in one copy
